...
## Project Structure
    ...
    ├── testapiautocatalog_112889  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112889`
...
2. Clone this repo and `cd testapiautocatalog_112889`
